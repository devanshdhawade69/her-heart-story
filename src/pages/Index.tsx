...
import birthdayFinale from "@/assets/birthday-finale.jpg";
    ...
    <div className="min-h-screen bg-gradient-hero relative overflow-hidden">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="font-playfair text-6xl md:text-8xl font-bold mb-8 text-foreground">
            Hey Love...
          </h1>
          {showContent && (
            <div className="space-y-6 animate-fade-in">
              ...
              <Button 
                ...
                size="lg"
                className="mt-12 rounded-full shadow-glow animate-pulse-glow"
              >
                Begin Our Journey
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {photoGallery.map((photo, index) => (
              <Card 
                key={index}
                className="group overflow-hidden bg-gradient-card shadow-soft hover:shadow-strong transition-all duration-500 transform hover:scale-105 animate-fade-in"
                ...
                <CardContent className="p-0">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end">
                      <p className="text-white p-6 font-playfair text-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        {photo.caption}
                      </p>
                    </div>
                  </div>
      ...
      <section id="letter" ref={letterRef} className="py-32 px-4 relative z-10 bg-gradient-dark">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-playfair text-5xl md:text-6xl font-bold mb-6 text-primary">
            ...
            <CardContent>
              {showLetter ? (
                <TypingEffect 
                  ...
                  delay={30}
                  className="whitespace-pre-wrap text-lg leading-relaxed text-foreground/90 font-sans"
                />
              ) : (
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-gradient-card shadow-soft hover:shadow-glow transition-all">
              <p className="text-lg text-muted-foreground mb-2">
                "This one reminds me of your sleepy voice in the morning"
              </p>
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex justify-center gap-4 mb-8">
              {[...Array(5)].map((_, i) => (
                <Sparkles 
                  key={i}
                  className="w-8 h-8 text-accent animate-twinkle"
            ...
            <h2 className="font-playfair text-6xl md:text-8xl font-bold mb-8 text-foreground">
              Happy Birthday!
            </h2>
            
            <div className="space-y-6 text-xl md:text-2xl text-foreground/90 leading-relaxed mb-12">
              <p>
                Today is YOUR day, and I hope it's filled with as much joy as you bring into my life every single day.
              </p>
              <p>
                You deserve all the happiness in the world, all the love, all the magic.
              </p>
              <p className="font-playfair text-3xl md:text-4xl font-bold text-primary pt-6">
                Thank you for being you. I love you more than words can express. ❤️
              </p>
            </div>
            ...
            <Button 
              size="lg"
              className="text-xl px-12 py-6 rounded-full shadow-glow animate-pulse-glow"
